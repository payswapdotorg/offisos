"""RESEARCH-CAD-004 benchmark orchestrator.
...
BENCHMARKS = [
    ...
    ("bench-provenance", bench_provenance),
    ("bench-propagation", bench_propagation),
    ("bench-graph", bench_graph),
    ("bench-downstream", bench_downstream),
