"""Evidence harness for the RESEARCH-CAD-003 benchmark.

Vendored and adapted from research/cad-001/offisos_cadbench/harness.py
(conventions proven in RESEARCH-CAD-001/002) so this evidence package is
independently reproducible without runtime coupling between work items.
